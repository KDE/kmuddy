  ...
  : QTreeView (parent)
{
  ...
  connect (actDeleteObj, &QAction::triggered, this, &cListViewer::deleteObject);
  d->col->addAction ("DeleteObject", actDeleteObj);
  QAction *actDeleteGroup = new QAction (this);
  actDeleteGroup->setText (i18n ("Delete group"));
  connect (actDeleteGroup, &QAction::triggered, this, &cListViewer::deleteObject);
  ...
  connect (actAddSubGroup, &QAction::triggered, this, &cListViewer::addGroup);
  ...
  connect (actAddGroup, &QAction::triggered, this, &cListViewer::addGroup);
  ...
  connect (actAddObject, &QAction::triggered, this, &cListViewer::addObject);
